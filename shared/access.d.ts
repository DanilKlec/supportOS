...
export type Permission = 'work'|'binds.read'|'binds.manage'|'projects.read'|'bonuses.read'|'bonuses.write'|'tools'|'monitor.read'|'monitor.write'|'knowledge.write'|'ai.train'|'users.manage'|'roles.manage'|'technical';
