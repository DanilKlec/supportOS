...
export const SEED_BINDS: Bind[] = [
	{
		...
		translations: {
			ru: {
				...
				command:
					"Здравствуйте! Меня зовут {имя}, я специалист поддержки. Чем могу помочь?",
			...
			en: {
				...
				command:
					"Hello! My name is {name}, I am a support specialist. How can I help you today?",
	...
	},
	{
		...
		translations: {
			ru: {
				...
				content:
					"Напомните клиенту кратко предыдущее обращение и предложите продолжить решение вопроса.",
				lastModified: now,
			},
			en: {
				title: "Returning customer greeting",
				command:
					"Nice to see you again! I remember we discussed {topic}. Shall we continue?",
				description: "Restore context after a break",
				content:
					"Remind the customer of the previous conversation and offer to continue resolving the issue.",
				lastModified: now,
			},
		},
		createdAt: now,
	...
	},
	{
		...
		translations: {
			...
			en: {
				...
				command:
					"I checked your payment — it was successful on {date}. Your subscription is active until {expiry_date}.",
	...
	},
	{
		...
		translations: {
			...
			en: {
				...
				command:
					"I have submitted a refund request. The funds will appear on your card within 5–10 business days.",
	...
	},
	{
		...
		translations: {
			ru: {
				...
				content:
					"Попросите клиента перезапустить приложение и очистить кэш, чтобы исключить временные ошибки.",
				lastModified: now,
			},
			en: {
				title: "Restart app",
	...
	},
	{
		...
		translations: {
			ru: {
				...
				command:
					"Передал ваш запрос команде разработки. Ожидайте ответ в течение 24 часов.",
				description: "Переадресация на следующий уровень поддержки",
				content:
					"Сообщите клиенту, что его запрос передан в команду разработки с ожиданием ответа в пределах 24 часов.",
				lastModified: now,
			},
			en: {
				title: "Escalation to L2",
				command:
					"I have forwarded your request to the development team. Please expect a response within 24 hours.",
	...
	},
	{
		...
		translations: {
			ru: {
				...
				command:
					"Рад был помочь! Если возникнут вопросы — обращайтесь. Хорошего дня! 🙂",
				description: "Завершение разговора клиента",
				content:
					"Поблагодарите клиента за обращение и оставьте открытыми дальнейшие контакты.",
				lastModified: now,
			},
			en: {
				title: "Conversation close",
				command:
					"Glad I could help! If you have any more questions, feel free to reach out. Have a great day! 🙂",
				description: "Close the dialog politely",
				content:
					"Thank the customer and leave the door open for future contact.",
				lastModified: now,
			},
		},
		createdAt: now,
	...
	},
	{
		...
		translations: {
			ru: {
				title: "Запрос оценки",
				command:
					"Буду благодарен, если оцените качество поддержки после завершения чата.",
				description: "Просьба оставить отзыв",
				content:
					"Попросите клиента оставить отзыв о поддержке, чтобы повысить качество сервиса.",
				lastModified: now,
			},
			en: {
				title: "Feedback request",
				command:
					"I would appreciate it if you could rate the support quality after the chat ends.",
				description: "Ask for a review",
				content:
					"Ask the customer to leave feedback to help improve service quality.",
				lastModified: now,
			},
		},
		createdAt: now,
