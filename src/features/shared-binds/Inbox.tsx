					...
					<div className="ui-actions items-center mb-4 flex flex-wrap gap-2">
						{[
							...
							<button
								...
								className="ui-button ui-button--secondary border border-border aria-pressed:bg-surface-elevated"
							>
								{t.label}
							</button>
						))}
							...
							>
								...
								<div className="ui-actions items-center flex  gap-3">
									...
									<button
										...
										className="ui-button ui-button--primary ml-auto bg-accent text-accent-foreground"
									>
